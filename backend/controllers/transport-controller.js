...
const getAllBusRoutes = async (req, res) => {
    try {
        ...
        // Demo mode response
        if (req.demoMode) {
            console.log('🎯 Demo mode: Returning demo transport routes data');
                ...
                data: [
                    {
                        ...
                        Buses: [
                            { id: '1', busNumber: 'BUS001', capacity: 45, status: 'active' },
                            { id: '2', busNumber: 'BUS002', capacity: 45, status: 'active' }
                        ]
                    },
                    {
                        id: '2',
                        ...
                        Buses: [
                            { id: '3', busNumber: 'BUS003', capacity: 45, status: 'active' }
                        ]
                    },
                    {
                        id: '3',
                        ...
                        Buses: [
                            { id: '4', busNumber: 'BUS004', capacity: 50, status: 'active' },
                            { id: '5', busNumber: 'BUS005', capacity: 50, status: 'maintenance' }
                        ]
                    },
                    {
                        id: '4',
                        ...
                        Buses: [
                            { id: '6', busNumber: 'BUS006', capacity: 55, status: 'active' }
                        ]
                    },
                    {
                        id: '5',
                        routeName: 'Mall Circuit',
                        startPoint: 'College Gate',
                        ...
                        Buses: [
                            { id: '7', busNumber: 'BUS007', capacity: 40, status: 'active' }
                        ]
                    }
                ],
                pagination: {
...
const getAllBuses = async (req, res) => {
    try {
        ...
        // Demo mode response
        if (req.demoMode) {
            console.log('🎯 Demo mode: Returning demo buses data');
            const demoBuses = [
                {
                    id: '1',
                    busNumber: 'BUS001',
                    ...
                    status: 'active',
                    createdAt: new Date('2026-01-15'),
                    route: { id: '1', routeName: 'City Center Route' }
                },
                {
                    id: '2',
                    busNumber: 'BUS002',
                ...
                },
                {
                    id: '3',
                    busNumber: 'BUS003',
                    registrationNo: 'KA01AB1236',
                    capacity: 45,
                    driverName: 'Mahesh Singh',
                    driverPhone: '9876543212',
                    status: 'active',
                    createdAt: new Date('2026-01-25'),
                    route: { id: '2', routeName: 'Residential Route' }
                },
                {
                    id: '4',
                    busNumber: 'BUS004',
                    registrationNo: 'KA01AB1237',
                    capacity: 50,
                    driverName: 'Vikram Rao',
                    driverPhone: '9876543213',
                    status: 'active',
                    createdAt: new Date('2026-02-01'),
                    route: { id: '3', routeName: 'Tech Park Route' }
                },
                {
                    id: '5',
                    busNumber: 'BUS005',
                    registrationNo: 'KA01AB1238',
                    capacity: 50,
                ...
                },
                {
                    id: '6',
                    busNumber: 'BUS006',
                    registrationNo: 'KA01AB1239',
                    capacity: 55,
                    driverName: 'Ravi Sharma',
                    driverPhone: '9876543215',
                    status: 'active',
                    createdAt: new Date('2026-02-10'),
                    route: { id: '4', routeName: 'Airport Express' }
                },
                {
                    id: '7',
                    busNumber: 'BUS007',
                    registrationNo: 'KA01AB1240',
                    capacity: 40,
                    driverName: 'Deepak Gupta',
                    driverPhone: '9876543216',
                    status: 'active',
                    createdAt: new Date('2026-02-15'),
                    route: { id: '5', routeName: 'Mall Circuit' }
                }
            ];

            // Filter by routeId if provided
            const filteredBuses = routeId 
                ? demoBuses.filter(bus => bus.route.id === routeId)
                : demoBuses;
            ...
            return res.status(200).json({
                ...
                pagination: {
                    ...
                    page: parseInt(page),
                    limit: parseInt(limit),
                    pages: Math.ceil(filteredBuses.length / limit)
                }
            });
        }
