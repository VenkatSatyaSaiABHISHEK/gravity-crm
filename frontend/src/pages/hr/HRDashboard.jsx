...
function HRDashboard() {
  ...
  // Get employees and attendance from Redux
  ...
  // Update loading state based on employees
  useEffect(() => {
    setLoading(employees.length === 0);
  }, [employees]);
      ...
      <EmployeeProvider>
        {(() => {
          switch (activeSection) {
            ...
            case 1:
              return <EmployeeManagement isHRRole={true} />;
            case 2:
              return <AttendanceManagement employees={employees} attendance={attendance} setAttendance={(newAttendance) => dispatch(setAttendance(newAttendance))} />;
            case 3:
